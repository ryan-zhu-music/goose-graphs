...
- Since only 100 segments are drawn, equations requiring higher detail will not be drawn accurately, e.g. sin(6x)
...
* All levels are solvable without encountering these bugs.
